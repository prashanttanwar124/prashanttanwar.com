...
const projects = [
  ...
  },
  {
    ...
    tags: ['Canvas', 'Generative', 'Teaching'],
    desc: 'Interactive sketches built for creative-coding lessons — flow fields, particles, playful chaos.',
    link: '',
    repo: '',
  },
  {
    n: '04',
    title: 'Stock Brain',
    subtitle: 'inventory tool',
    tags: ['Web App', 'UI', 'MySQL'],
    desc: 'A lightweight inventory tracker born from retail life — stock levels, search, simple reports.',
    link: '',
    repo: '',
  },
]
